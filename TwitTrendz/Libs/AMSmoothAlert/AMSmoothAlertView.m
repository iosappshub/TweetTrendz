...
{
    UIView * alertSquare = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 200, 200)];
...
-(void) performScreenshotAndBlur
{
    ...
    UIColor *blurTintColor = REUIKitIsFlatMode() ? nil : [UIColor colorWithWhite:1 alpha:0.75f];
    CGFloat blurSaturationDeltaFactor = 1.8f;
    CGFloat blurRadius = 10.0f;
    UIImage *blurImage = [image re_applyBlurWithRadius:blurRadius tintColor:blurTintColor saturationDeltaFactor:blurSaturationDeltaFactor maskImage:nil];
    [bg setImage:blurImage];
    bg.alpha = 0.0;
...
- (void) labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 180, 100)];
    ...
    _textLabel.textColor = [UIColor colorWithRed:62/255.0f green:68/255.0f blue:75/255.0f alpha:1.0f];
...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    if (hasCancelButton) {
        //default button
        _defaultButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 50, 84, 30)];
        _defaultButton.center = CGPointMake((alertView.frame.size.width/4)+3, 170);

        //cancel button
        _cancelButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 50, 84, 30)];
        _cancelButton.center = CGPointMake((alertView.frame.size.width*3/4)-3, 170);
        ...
        _defaultButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 50, 180, 30)];
